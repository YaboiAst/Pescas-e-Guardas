...
public class NVBoids : MonoBehaviour
{
    ...
    public List<GameObject> birdPrefs = new List<GameObject>();
    ...
    void Awake()
    {
        int rand = Random.Range(0, birdPrefs.Count);
        birdPref = birdPrefs[rand];
    ...
    void CreateBird()
    {
        ...
        for (int b = 0; b < birdsNum; b++)
        {
            ...
            birdsTransform[b].GetComponent<Renderer>().material.color = _colors[rand];
            Vector3 lpv = Random.insideUnitSphere * fragmentedBirds;
